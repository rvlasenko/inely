...
return [
    ...
    'EVE is one of several robots who are sent to Earth. She has a scanner she likes to fly and likes draw. After meeting you, she making a top priority to protect you.' => 'Eve - один из нескольких роботов посланных на Землю. Оснащена сканером, умеет летать и любит рисовать. После встречи с тобой, она делает своим главным приоритетом защищать тебя.',
