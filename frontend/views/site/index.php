    ...
    <div class="header-left">
        <div class="topnav">
            ...
            <ul class="nav nav-icons">
                <li>
                    <a href="#"><span class="icon-bulb"></span></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <ul class="header-menu nav navbar-nav">
            ...
            <li class="dropdown" id="language-header">
                ...
                <ul class="dropdown-menu lang">
                    <li>
                        <a href="#" data-lang="ru"><img src="images/flags/Russia.png" alt="flag-english"> <span>Русский</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" data-lang="en"><img src="images/flags/USA.png" alt="flag-english"> <span>Английский</span>
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <ul class="dropdown-menu-list withScroll" data-height="220">
                            ...
                            <li>
                                <a href="#">
                                    <i class="fa fa-heart p-r-10 f-18 c-red"></i> John added you to his favs
            ...
            <!-- END USER DROPDOWN -->
            <!-- CHAT BAR ICON -->
            <li id="quickview-toggle"><a href="#"><i class="icon-notebook"></i></a>
            </li>
        </ul>
    </div>
    <!-- header-right -->
...
<div class="row">
        ...
        <div class="panel widget-map">
            ...
            <div class="panel-content widget-news">
                <div class="withScroll _mCS_23 mCustomScrollbar _mCS_7" data-height="400" style="height: 400px;">
                    <div class="mCustomScrollBox mCS-light mCS-mouse-over" id="mCSB_7" style="position:relative; height:100%; overflow:hidden; max-width:100%;">
                        <div class="mCSB_container" style="position: relative; top: 0px;">
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <div class="media-body">
                                        <div class="pull-left p-r-10"><img src="http://www.nose2tail.co.uk/cat-matlock-derbyshire.jpg" style="width: 90px;"> </div>
                            ...
                            <a href="#" class="message-item media">
                                <div class="media">
                                    <div class="media-body">
                                        <div class="pull-left p-r-10"><img src="http://www.nose2tail.co.uk/cat-matlock-derbyshire.jpg" style="width: 90px;"></div>
                                        <div> <small class="pull-right">25 Feb</small>
                        ...
                        <div class="mCSB_scrollTools" style="position: absolute; display: block; opacity: 0;">
                            <div class="mCSB_draggerContainer">
                                <div class="mCSB_dragger" style="position: absolute; height: 263px; top: 0px;" oncontextmenu="return false;">
    ...
    <div class="col-xlg-3 col-lg-4">
        <?php $this->beginContent('@app/views/page/weather.php') ?>
        <?php $this->endContent() ?>
    </div>
    <div class="col-xlg-2 col-lg-3 hidden-sm">
        <div class="row">
            <div class="col-md-12">
...
<div class="row">
                ...
                <ul class="todo-list ui-sortable">
                    ...
                    <li class="low">
                      ...
                      <label for="task-3"></label>
                        ...
                        <div class="todo-date clearfix">
                            <div class="completed-date"></div>
                            <div class="due-date">Due on <span class="due-date-span">5 January</span>
                            </div>
                        </div>
                                        <span class="todo-options pull-right">
                      <a href="javascript:;" class="todo-delete"><i class="icons-office-52"></i></a>
                    ...
                    <li class="medium">
                      ...
                      <label for="task-4"></label>
                        ...
                        <div class="todo-date clearfix">
                            <div class="completed-date"></div>
                            <div class="due-date">Due on <span class="due-date-span">4 January</span>
                            </div>
                        </div>
                                        <span class="todo-options pull-right">
                      <a href="javascript:;" class="todo-delete"><i class="icons-office-52"></i></a>
                    ...
                    <li>
                      ...
                      <label for="task-6"></label>
                        ...
                        <div class="todo-date clearfix">
                            <div class="completed-date"></div>
                            <div class="due-date">Due on <span class="due-date-span">1 January</span>
                            </div>
                        </div>
                                        <span class="todo-options pull-right">
                      <a href="javascript:;" class="todo-delete"><i class="icons-office-52"></i></a>
    ...
    <div class="col-md-4 col-sm-6 portlets">
        ...
        <div class="panel widget-member clearfix">
            <div class="col-xs-3">
                <img src="images/avatars/avatar1_big@2x.png" alt="avatar 12" class="pull-left img-responsive">
            </div>
            <div class="col-xs-9">
                ...
                <div class="row">
                    <div class="col-xlg-6">
                        ...
                        <p><i class="icon-social-facebook c-gray-light p-r-10"></i> fb.com/jsnow</p>
                    </div>
