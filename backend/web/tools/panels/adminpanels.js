         ...
         controlHandlers: function(e) {
            ...
            var panelRemove = function() {
              panel.children('.panel-heading')
                   ...
                   .children('.panel-control-remove').hide()
                   .parent()
                   .prepend('<a href="#" class="panel-control-agree"></a>')
                   .prepend('<a href="#" class="panel-control-disallow"></a>');
              ...
              $('.panel-control-disallow').click(function() {
                panel.children('.panel-heading')
                     .children('.panel-controls')
                     .prepend('<a href="#" class="panel-control-remove"></a>');
