        ...
        var methods = {
            ...
            controlHandlers     : function (e) {
                ...
                var panelRemove = function () {
                    panel.children('.panel-heading').children('.panel-controls').children('.panel-control-remove').hide().parent().prepend('<a href="#" class="panel-control-agree"></a>').prepend('<a href="#" class="panel-control-disallow"></a>');
                    $('.panel-control-agree').click(function () {
                        panel.addClass('panel-removed').hide();
                        methods.updateSettings(options);
                    });

                    $('.panel-control-disallow').click(function () {
                        panel.children('.panel-heading').children('.panel-controls').prepend('<a href="#" class="panel-control-remove"></a>');
                        $('.panel-control-disallow').hide();
                        $('.panel-control-agree').hide();
                    });
                    /*new noty({
                     layout: 'centerRight',
                     theme: 'relax',
