!function (e) {
    ...
    "use strict";
    if (!e.jstree) {
        var i, r, acc = false, lol, lal, shit, listOfNodes = [], allow = true, s = 0, n = !1, a = !1, o = !1, d = [], c = e("script:last").attr("src"), l = window.document, h = l.createElement("LI");
            ...
            redraw_node:                 function (t, i, r, s) {
                ...
                if (n.text) {
                    ...
                    if (n.text.indexOf("!1") !== -1) {
                        t.childNodes[ 1 ].classList.add("high");
                        n.text = n.text.replace('!1', '').trim();
                    } else if (n.text.indexOf("!2") !== -1) {
                        t.childNodes[ 1 ].classList.add("medium");
                ...
                if (g.length && (t.childNodes[ 1 ].className = "jstree-anchor " + g),
                    ...
                    && n.icon ? t.childNodes[ 1 ].childNodes[ 2 ].className += " " + n.icon + " jstree-themeicon-custom" : (t.childNodes[ 1 ].childNodes[ 2 ].style.backgroundImage = "url(" + n.icon + ")",
                        t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundPosition = "center center",
                        t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundSize = "auto",
                        t.childNodes[ 1 ].childNodes[ 2 ].className += " jstree-themeicon-custom")),
                        t.childNodes[ 1 ].childNodes[ 1 ].className += "due-date tooltitle",
                        ...
                        this.settings.core.force_text ? t.childNodes[ 1 ].appendChild(f.createTextNode(n.text)) :
                            ...
                            (!$(t).hasClass("jstree-leaf")) ? t.childNodes[ 1 ].childNodes[ 1 ].classList.add("ml-30"):
                                n.a_attr.date ? t.childNodes[ 1 ].childNodes[ 3 ].innerHTML = n.a_attr.date : false,
                                n.a_attr.badge ? t.childNodes[ 1 ].className += ' ' + n.a_attr.badge : false,
                                t.childNodes[ 1 ].childNodes[ 2 ].innerHTML = n.text ? n.text.trim() : n.text,
                                n.a_attr.rel ? t.childNodes[ 1 ].childNodes[ 3 ].className += " " + n.a_attr.rel : false,
                                n.a_attr.format ? t.childNodes[ 1 ].childNodes[ 3 ].className += n.a_attr.format : false,
                                n.a_attr.hint ? t.childNodes[ 1 ].childNodes[ 3 ].setAttribute('title', n.a_attr.hint) : false,
