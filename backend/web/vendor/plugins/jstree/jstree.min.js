!function (e) {
    ...
    "use strict";
    if (!e.jstree) {
        var i, r, lol, s = 0, n = !1, a = !1, o = !1, d = [], c = e("script:last").attr("src"), l = window.document, h = l.createElement("LI");
        ...
        r = l.createElement("I"),
            ...
            h.appendChild(i),
            i.appendChild(r), i = lol = r = null, e.jstree = {
            version: "3.2.1",
            defaults: { plugins: [] },
            plugins: {},
            ...
            redraw_node:                 function (t, i, r, s) {
                ...
                if (g.length && (t.childNodes[ 1 ].className = "jstree-anchor " + g),
                    ...
                    (n.icon === !1 ? t.childNodes[ 1 ].childNodes[ 1 ].className += " jstree-themeicon-hidden" : -1 === n.icon.indexOf("/")
                    && -1 === n.icon.indexOf(".") ? t.childNodes[ 1 ].childNodes[ 1 ].className += " " + n.icon + " jstree-themeicon-custom" : (t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundImage = "url(" + n.icon + ")",
                        ...
                        this.settings.core.force_text ? t.childNodes[ 1 ].appendChild(f.createTextNode(n.text)) :
                            t.childNodes[ 1 ].childNodes[ 0 ].innerHTML += n.text, i && n.children.length && (n.state.opened || s) && n.state.loaded) {
            ...
            refresh_node:                function (t) {
                ...
                r.push(t.id), t.state.opened === !0 && i.push(t.id), this.get_node(t, !0).find(".jstree-open").each(function () {i.push(this.id)}), this._load_nodes(r, e.proxy(function (e) {
