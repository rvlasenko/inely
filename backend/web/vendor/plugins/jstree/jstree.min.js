        ...
        r = l.createElement("I"),
            ...
            redraw_node:                 function (t, i, r, s) {
                ...
                if (g.length && (t.childNodes[ 1 ].className = "jstree-anchor " + g),
                    ...
                    (n.icon === !1 ? t.childNodes[ 1 ].childNodes[ 1 ].className += "due-date hint--bottom" : -1 === n.icon.indexOf("/")
                    && -1 === n.icon.indexOf(".") ? t.childNodes[ 1 ].childNodes[ 1 ].className += " " + n.icon + " jstree-themeicon-custom" : (t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundImage = "url(" + n.icon + ")",
                        t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundPosition = "center center",
                        t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundSize = "auto",
                        t.childNodes[ 1 ].childNodes[ 1 ].className += " jstree-themeicon-custom")),
                        n.text.substring(0, 2) == '--' ? t.childNodes[ 1 ].childNodes[ 0 ].className += ' bold ' : false,
                        n.text.substring(0, 2) == '--' ? n.text = n.text.substring(2, n.text.length).trim() : false,
                        n.text.substring(0, 2) == '__' ? t.childNodes[ 1 ].childNodes[ 0 ].className += ' cursive ' : false,
                        n.text.substring(0, 2) == '__' ? n.text = n.text.substring(2, n.text.length).trim() : false,
                        n.text.substring(0, 3) == '!!1' ? t.childNodes[ 1 ].className += ' high ' : false,
                        n.text.substring(0, 3) == '!!1' ? n.text = n.text.substring(3, n.text.length).trim() : false,
                        n.text.substring(0, 3) == '!!2' ? t.childNodes[ 1 ].className += ' medium ' : false,
                        n.text.substring(0, 3) == '!!2' ? n.text = n.text.substring(3, n.text.length).trim() : false,
                        n.text.substring(0, 3) == '!!3' ? t.childNodes[ 1 ].className += ' low ' : false,
                        n.text.substring(0, 3) == '!!3' ? n.text = n.text.substring(3, n.text.length).trim() : false,
                        ...
                        this.settings.core.force_text ? t.childNodes[ 1 ].appendChild(f.createTextNode(n.text)) :
                            n.text == 'New node' ? t.classList.add("hidden") :
                                ...
                                t.childNodes[ 1 ].childNodes[ 0 ].innerHTML = n.text.trim(),
