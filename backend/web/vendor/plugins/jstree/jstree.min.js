                    ...
                    && -1 === n.icon.indexOf(".") ? t.childNodes[ 1 ].childNodes[ 1 ].className += " " + n.icon + " jstree-themeicon-custom" : (t.childNodes[ 1 ].childNodes[ 1 ].style.backgroundImage = "url(" + n.icon + ")",
                        ...
                        this.settings.core.force_text ? t.childNodes[ 1 ].appendChild(f.createTextNode(n.text)) :
                            n.text == 'New node' ? t.classList.add("hidden") :
                                n.li_attr.value ? t.childNodes[ 1 ].childNodes[ 1 ].innerHTML = n.li_attr.value : false,
                                t.childNodes[ 1 ].childNodes[ 0 ].innerHTML = n.text,
                                n.li_attr.href ? t.childNodes[ 1 ].childNodes[ 1 ].className += " " + n.li_attr.href : false,
                                true ? t.childNodes[ 1 ].childNodes[ 1 ].setAttribute('data-hint', n.li_attr.id) : false,
