!function (e) {
    ...
    "use strict";
    if (!e.jstree) {
        var i, r, lol, lal, shit, s = 0, n = !1, a = !1, o = !1, d = [], c = e("script:last").attr("src"), l = window.document, h = l.createElement("LI");
        h.setAttribute("role", "treeitem"),
            ...
            redraw_node:                 function (t, i, r, s) {
                var n = this.get_node(t), svg = document.createElementNS("http://www.w3.org/2000/svg", "svg"), pol = document.createElementNS("http://www.w3.org/2000/svg", "polygon"), a = !1, o = !1, d = !1, c = !1, _ = !1, u = !1, g = "", f = l, p = this._model.data, m = !1, v = null, j = 0, y = 0, k = !1, x = !1;
                if (!n)return !1;
                ...
                if (g.length && (t.childNodes[ 1 ].className = "jstree-anchor " + g),
                    ...
                    && n.icon ? t.childNodes[ 1 ].childNodes[ 2 ].className += " " + n.icon + " jstree-themeicon-custom" : (t.childNodes[ 1 ].childNodes[ 2 ].style.backgroundImage = "url(" + n.icon + ")",
                        ...
                        t.childNodes[ 1 ].childNodes[ 1 ].className += "due-date hint--bottom",
                        ...
                        this.settings.core.force_text ? t.childNodes[ 1 ].appendChild(f.createTextNode(n.text)) :
                            ...
                            n.text == 'Root' ? t.childNodes[ 1 ].classList.add("hidden-im") :
                                n.li_attr.date ? t.childNodes[ 1 ].childNodes[ 1 ].innerHTML = n.li_attr.date : false,
                                n.a_attr.badge ? t.childNodes[ 1 ].className += ' ' + n.a_attr.badge : false,
                                t.childNodes[ 1 ].childNodes[ 0 ].innerHTML = n.text ? n.text.trim() : n.text,
                                n.li_attr.rel ? t.childNodes[ 1 ].childNodes[ 1 ].className += " " + n.li_attr.rel : false,
                                n.a_attr.format ? t.childNodes[ 1 ].childNodes[ 0 ].className += n.a_attr.format : false,
                                n.li_attr.hint ? t.childNodes[ 1 ].childNodes[ 1 ].setAttribute('data-hint', n.li_attr.hint) : false,
            ...
            refresh:                     function (t, i) {
                ...
                "<img src='vendor/plugins/jstree/themes/proton/preloader.gif' " +
