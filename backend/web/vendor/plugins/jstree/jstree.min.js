    ...
    if (!e.jstree) {
        ...
        r = l.createElement("I"),
            ...
            redraw_node:                 function (t, i, r, s) {
                var n = this.get_node(t), svg = l.createElement("svg"), pol = l.createElement("polygon"), a = !1, o = !1, d = !1, c = !1, _ = !1, u = !1, g = "", f = l, p = this._model.data, m = !1, v = null, j = 0, y = 0, k = !1, x = !1;
                if (!n)return !1;
                ...
                n.text ? n.text.substring(0, 2) == '--' ? t.childNodes[ 1 ].childNodes[ 0 ].className = ' bold ' : false : false,
                n.text ? n.text.substring(0, 2) == '--' ? n.text = n.text.substring(2, n.text.length).trim() : false : false,
                n.text ? n.text.substring(0, 2) == '__' ? t.childNodes[ 1 ].childNodes[ 0 ].className = ' cursive ' : false : false,
                n.text ? n.text.substring(0, 2) == '__' ? n.text = n.text.substring(2, n.text.length).trim() : false : false,
                n.text ? n.text.substring(0, 3) == '!1' ? t.childNodes[ 1 ].className += ' high ' : false : false,
                n.text ? n.text.substring(0, 3) == '!1' ? n.text = n.text.substring(3, n.text.length).trim() : false : false,
                n.text ? n.text.substring(0, 3) == '!2' ? t.childNodes[ 1 ].className += ' medium ' : false : false,
                n.text ? n.text.substring(0, 3) == '!2' ? n.text = n.text.substring(3, n.text.length).trim() : false : false,
                n.text ? n.text.substring(0, 3) == '!3' ? t.childNodes[ 1 ].className += ' low ' : false : false,
                n.text ? n.text.substring(0, 3) == '!3' ? n.text = n.text.substring(3, n.text.length).trim() : false : false;
