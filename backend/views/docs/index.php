...
<div class="page js-page">
    <div class="one-page-sidebar">
        <div class="one-page-sidebar-header">
            ...
            <div class="one-page-meta">
                <ul class="one-page-meta-list">
                    <li>
                        <a href="http://backend.inely.ru">
                            <i class="one-page-meta-list-icon fa fa-arrow-left"></i>Назад</a>
                    </li>
                    <li>
                        <a href="https://github.com/hirootkit/inely">
                            <i class="one-page-meta-list-icon fa fa-github-alt"></i>GitHub</a>
                    </li>
                    <li>
                        <a href="/docs">
                            <i class="one-page-meta-list-icon fa fa-question"></i>Помощь</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <ul class="one-page-nav js-one-page-nav js-menu-vertical" data-prepend-to=".js-prepend-mobile-menu">
                ...
                <li>
                    <a href="#browser-support" class="">
                        ...
                        </span>Совместимость</a>
                </li>
                <li>
                    <a href="#other-features" class="">
                        <span class="one-page-nav-icon">
                            <i class="fa fa-cubes"></i>
                        </span>Дополнительно</a>
                </li>
                <li>
                    <a href="#faq" class="">
                        <span class="one-page-nav-icon">
        ...
        <footer class="one-page-sidebar-footer">
            <a href="#">hirootkit</a>, all rights reserved. 2016 ©
        </footer>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="category-info helper pt0" id="main-features">
                            ...
                            <p class="category-content">Inely это простой, стильный, и легкий в использовании инструмент управления задачами. Создавайте задачи, которые покроют всю вашу повседневную жизнь, и организуют их в виде проектов, таких как "Работа", "Покупки" или чего-либо ещё, что вам нравится. </p>
                            <p class="category-content">Вы также можете поделиться проектами с друзьями или коллегами. Inely можно использовать как инструмент совместной работы, чтобы помочь друг другу достичь поставленных целей.</p>
                            <p class="category-content">P.S. Если данный проект показался вам интересным, и вы цените этот труд, пожалуйста, поставьте ему <a href="https://github.com/hirootkit/inely" target="_blank" class="text-warning">оценку на Github.</a> Чувствуете, что проект этого не заслуживает? Пожалуйста, свяжитесь со мной и я сделаю все от меня зависящее!</p>
                        </div>
                        <div class="row">
                            <div class="col-md-4">

                                <div class="box box-small-icon">
                                    <img src="http://themes.vsart.me/vsdocs/img/demos/boxes/1.png" class="box-icon" alt="box icon">
                                    <h4 class="box-title">Подзадачи</h4>

                                    <p class="box-description">Добивайтесь большего, разбивая большой проект на несколько небольших задач.</p>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-small-icon">
                                    <img src="http://themes.vsart.me/vsdocs/img/demos/boxes/2.png" class="box-icon" alt="box icon">
                                    <h4 class="box-title">Общий доступ</h4>

                                    <p class="box-description">Делитесь своими списками с коллегами, друзьями или родными и обсуждайте детали.</p>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-small-icon">
                                    <img src="http://themes.vsart.me/vsdocs/img/demos/boxes/3.png" class="box-icon" alt="box icon">
                                    <h4 class="box-title">Интуитивный ввод</h4>

                                    <p class="box-description">Легко добавлять сведения о задаче человеческим языком, например, ":завтра"</p>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="box box-small-icon">
                                    <img src="http://themes.vsart.me/vsdocs/img/demos/boxes/4.png" class="box-icon" alt="box icon">
                                    <h4 class="box-title">Заметки</h4>

                                    <p class="box-description">Добавляйте сколько угодно много деталей и не упустите ни одну из идей.</p>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-small-icon">
                                    <img src="http://themes.vsart.me/vsdocs/img/demos/boxes/5.png" class="box-icon" alt="box icon">
                                    <h4 class="box-title">Система приоритетов</h4>

                                    <p class="box-description">Концентрируйтесь на самом важном, назначая задачам один из трёх приоритетов.</p>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-small-icon">
                                    <img src="http://themes.vsart.me/vsdocs/img/demos/boxes/6.png" class="box-icon" alt="box icon">
                                    <h4 class="box-title">Контекст</h4>

                                    <p class="box-description">Добавляйте больше контекста Вашим задачам, становясь организованнее.</p>
                                </div>
                        ...
                        <div class="category-info " id="browser-support">
                            <h3 class="category-title"> Совместимость
                            ...
                            <h4 class="category-description">Мы поддерживаем самые последние версии следующих браузеров и платформ, включая Internet Explorer 9+. Более конкретная информация о поддержке предоставляется ниже.</h4>
                        </div>
                                ...
                                <div class="browser-icon">
                                    <svg enable-background="new 0 0 515.91 728.5" height="64" id="Layer_2" viewBox="0 0 512.00003 512" width="64" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g id="g6625" transform="translate(-141.91412,-143.63566)">
                                            ...
                                            <path d="M 634.66615,303.63565 H 485.91414 c 26,26 43.008,59.344 43.008,96.00001 0,27.344 -7.664,52.336 -23.008,75.008 l -104.992,180.99201 c 70,-0.672 129.664,-26 179.00801,-76 49.312,-50.00001 73.984,-110.00001 73.984,-180.00001 0,-32.65601 -5.504,-67.00801 -19.248,-96.00001 z" id="path9-7" style="fill:#fed14b" />
                        ...
                        <div class="category-info" id="other-features">
                            <h3 class="category-title">Дополнительные функции
                                <a class="fragment-identifier js-fragment-identifier fragment-identifier-scroll" href="#other-features">
                                    <i class="fa fa-link"></i>
                                </a>
                            </h3>

                            <p class="category-content">С Inely вы можете делиться проектами с другими людьми,
                                                        таким образом получая контроль над всеми задачами в общем проекте и
                                                        возможность работать вместе с командой над их завершением.
                                                        Вы также можете просматривать ваши задачи разными способами.
                                                        Например, через список всех задач на сегодня или на следующие семь дней.
                                                        Вы также можете повторно реорганизовывать ваши задачи с помощью
                                                        перетаскивания drag & drop, добавлять примечания к ним, комментарии,
                                                        разбивать задачи на подзадачи, и организовывать их в проекты.
                                                        И наконец, вы можете персонализировать ваш Inely, выбирая различный фон
                                                        и окружение.</p>
                        </div>
