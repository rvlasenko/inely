...
4. Инициализируйте окружение ```php console/yii app/setup``` и обновите зависимости, если вы этого ещё не делали.

На этом всё. После этих действий приложение будет доступно по адресу http://madeasy.local на базе сервера Apache 2.4 и MySQL 5.6