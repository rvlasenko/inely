...
4. Войдите в машину через ssh, перейдите в папку ```/var/www/madeasy.dev```, инициализируйте окружение ```php console/yii app/setup``` и обновите зависимости, если вы этого ещё не делали.
